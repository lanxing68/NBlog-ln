...
public class BlogController {
    ...
    public Result searchBlog(@RequestParam String query) {
        ...
        redisService.lPushWithLimit("searchHistory", query.trim(), 5, 7, TimeUnit.DAYS);
    ...
    public Result getSearchHistory() {
        List<String> history = redisService.lRangeList("searchHistory", 5);
        return Result.ok("获取成功", history);
    }
